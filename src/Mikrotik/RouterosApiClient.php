 ...
 * -----------------------------------------------------------------------
 * @deprecated Voir l'en-tête de RouterosClient.php : le routeur est
 * derrière un CGNAT, cette classe protocole est actuellement inutilisée
 * (aucune route ne l'appelle). Conservée pour une éventuelle architecture
 * réseau future, pas pour un usage immédiat.
 * -----------------------------------------------------------------------
