...
<head>
    ...
    <style>
        ...
        .metric-card .metric-icon { width:42px; height:42px; border-radius:12px; display:flex; align-items:center; justify-content:center; background:#eef3ff; color:var(--bleu-nuit); font-size:1.15rem; flex:0 0 42px; }
        .metric-card-warning .metric-icon { background:#fff4df; color:#a66600; }
        .metric-card-success .metric-icon { background:#e6f7ed; color:#198754; }
        .metric-card-danger .metric-icon { background:#fdebec; color:#b02a37; }
        .metric-card-info .metric-icon { background:#e8f5ff; color:#0d6efd; }
        ...
        .status-pill.warning { background:#fff3cd; color:#997404; }
        ...
        .table thead th { white-space:nowrap; font-size:.8rem; text-transform:uppercase; letter-spacing:.02em; color:#5f6b7a; background:#f8f9fb; }
        .data-table-shell { border:1px solid #e7ebf0; border-radius:12px; overflow:hidden; background:#fff; }
        #backToTop { position:fixed; bottom:30px; right:30px; display:none; width:48px; height:48px; border-radius:50%; background:var(--orange); color:#fff; border:none; font-size:1.5rem; cursor:pointer; box-shadow:0 4px 8px rgba(0,0,0,.2); z-index:1000; }
