    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-custom text-center p-3">
                <h5>Base de données Supabase</h5>
                <p class="<?= $supabaseOK ? 'status-ok' : 'status-ko' ?>">
                    <?= $supabaseOK ? '✅ Connectée' : '❌ Indisponible' ?>
                </p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-custom text-center p-3">
                <h5>Stockage local</h5>
                <p class="status-ok">✅ Non utilisé</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-custom text-center p-3">
