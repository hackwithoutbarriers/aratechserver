...
<div class="container-fluid mt-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex flex-wrap align-items-center">
            <select id="period-select" class="form-select me-2 mb-2 mb-md-0" style="width: auto; min-width: 150px;">
            ...
            <div id="custom-dates" class="d-flex flex-wrap align-items-center" style="display: none;">
                <input type="date" id="start-date" class="form-control me-1 mb-1 mb-md-0" style="width: auto;">
                <input type="date" id="end-date" class="form-control me-1 mb-1 mb-md-0" style="width: auto;">
                <span id="custom-hint" class="text-muted ms-1" style="display: none;">Sélectionnez les deux dates</span>
            </div>
        </div>
    </div>
