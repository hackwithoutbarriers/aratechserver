...
<body>
    ...
    <li class="nav-item"><a class="nav-link" href="dashboard/index.php"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
    <li class="nav-item"><a class="nav-link" href="settings/status.php"><i class="bi bi-wifi"></i> Statut</a></li>
    <li class="nav-item"><a class="nav-link" href="hotspot/hotspot.php"><i class="bi bi-people"></i> Hotspot</a></li>
    <li class="nav-item"><a class="nav-link" href="hotspot/user-import.php"><i class="bi bi-file-earmark-arrow-up"></i> Import CSV Hotspot</a></li>
    <li class="nav-item"><a class="nav-link" href="inventory/inventory.php"><i class="bi bi-box-seam"></i> Gestion des Stocks</a></li>
    <li class="nav-item"><a class="nav-link" href="finances/finances.php"><i class="bi bi-cash-coin"></i> Finances</a></li>
    <li class="nav-item"><a class="nav-link" href="ads/ads.php"><i class="bi bi-megaphone"></i> Annonces</a></li>
    <li class="nav-item"><a class="nav-link" href="logs/logs.php"><i class="bi bi-journal-text"></i> Logs</a></li>
    <li class="nav-item"><a class="nav-link" href="finances/reports.php"><i class="bi bi-graph-up"></i> Rapports</a></li>
    <li class="nav-item"><a class="nav-link" href="settings/settings.php"><i class="bi bi-sliders"></i> Configuration</a></li>
</ul>
        </div>
    </div>
